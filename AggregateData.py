...
class PeriodData:
    ...
    def __init__(self, industry):
        ...
        self.totalResearchInvestment = industry.totalInvestmentInResearch.sum
        self.totalInnovationInvestment = industry.totalInvestmentInInnovation.sum
        self.totalImitationInvestment = industry.totalInvestmentInImitation.sum
        self.costShareOfInnovation = (industry.totalInvestmentInInnovation.sum / industry.totalInvestmentInResearch.sum) if industry.totalInvestmentInResearch.sum > 0 else 0
        self.firmsResearching = industry.nmbResearching.count
        self.firmsInnovating = industry.nmbInnovating.count
        self.firmsImitating = industry.nmbImitating.count
