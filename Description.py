    ...
    def describeAggregate(cls, industry):
        desc = (
                    ...
                    "Average output: {:.2f}\n"
                            ...
                            industry.totalInvestmentInResearch.sum,
                            industry.totalInvestmentInInnovation.sum,
                            industry.totalInvestmentInImitation.sum,
                            (industry.totalInvestmentInInnovation.sum / industry.totalInvestmentInResearch.sum) if industry.totalInvestmentInResearch.sum > 0 else 0,
