...
class Demand:
    ...
    def updateEqPrice(self):
        ...
        Logger.trace("Equilibrium price is {:.2f}; Demand intercept: {:d}; Active incumbents: {:d}; Active sum of MC: {:.2f}".format(self.eqPrice, Parameters.DemandIntercept, len(self.industry.activeIncumbentFirms), self.industry.currentActiveSumOfMC))
