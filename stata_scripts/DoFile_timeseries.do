...
global folder = "Chapter_5_NoShocks_NoCycles/500_replications/Time series"
...
tsline mktsize $period

gr_edit .yaxis1.title.text = {"Market size"}
gr_edit .xaxis1.title.text = {"$xAxisTitle"}
gr_edit .yaxis1.reset_rule 7, tickset(major) ruletype(suggest) 
gr_edit .yaxis1.title.style.editstyle size(vlarge) editcopy
gr_edit .yaxis1.title.style.editstyle margin(right) editcopy
...
global suffixMktSize = "MktSize"
graph save Graph "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixMktSize.gph", replace
...
// Exporting graphs do eps
set graphics on

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixMktSize.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixMktSize.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixAggOutput.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixAggOutput.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixAggProfits.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixAggProfits.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixMarketPrice.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixMarketPrice.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixTechDiversity.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixTechDiversity.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixFirms.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixFirms.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixIndustryMarginalCost.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixIndustryMarginalCost.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixIndustryPCM.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixIndustryPCM.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixGini.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixGini.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixAvgProxOptTech.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixAvgProxOptTech.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixConsumerSurplus.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixConsumerSurplus.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixRatioRes.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixRatioRes.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixRatioProfitable.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixRatioProfitable.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixAge.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixAge.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixCostShareInnovation.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixCostShareInnovation.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixShareCS.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixShareCS.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixHHI.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixHHI.eps", as(eps) replace

graph use "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixRD_Inn_Imi.gph"
graph export "/Users/jdimas/GitHub/ACEModel/data/$folder/$baseName.$suffixRD_Inn_Imi.eps", as(eps) replace
